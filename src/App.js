...
class App extends Component{
  state = {
    ...
    email: "",
    password: "",
    profileIconUrl: "http://ddragon.leagueoflegends.com/cdn/img/champion/splash/Aatrox_0.jpg",
    errorMessage: "",
    isLoggedIn: false,
    loginUsername: "",
    loginPassword: "",
  ...
  render(){
    return (
      <div className="App">
        ...
        <Switch>
            <Route exact path={ROUTES.HOME} render={() => <PlayerSearch props={this.props} isLoggedIn={this.state.isLoggedIn}/>} username={this.state.username} userId={this.state.userId}/>
